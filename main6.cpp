...
int main() {
    ...
    while (true) { // Бесконечный цикл, пока пользователь не введет 0
        ...
        case 1: {
            ...
            LinkedList linkedList; // Однонаправленный список
        ...
        case 3: {
            ...
            UnorderedSet uniqueParties; // Для партий, присутствующих только в одной группе
            for (int i = 0; i < n; ++i) {
                UnorderedSet temp = groups[i];
                for (int j = 0; j < n; ++j) {
                    if (i != j) {
            ...
            UnorderedSet allParties;  // Все партии
            ...
            UnorderedSet allCountryParties; // Все партии в стране
            ...
            UnorderedSet notVotedParties = allCountryParties.Except(allParties); // Партии, за которые не голосовали
